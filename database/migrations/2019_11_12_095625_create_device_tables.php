...
class CreateDeviceTables extends Migration
{
    ...
    public function up()
    {
        Schema::create('devices', function (Blueprint $table) {
            ...
            $table->string('serial', 64)->nullable()->index()->comment = '设备序列号';

            $table->string('brand', 32)->nullable()->index()->comment = '设备品牌，比如:LG，Redmi';
            $table->string('model', 32)->index()->nullable()->comment = '设备型号，比如:Note 8';
            $table->string('arch', 32)->nullable()->comment = 'CPU平台，比如armeabi-v7a_armeabi';
            ...
            $table->tinyInteger('is_rooted')->index()->default(0)->comment = '是否Root或越狱';
            $table->tinyInteger('is_simulator')->index()->default(0)->comment = '是否模拟器';
